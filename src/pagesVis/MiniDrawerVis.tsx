...
import Acceuil from './AcceuilVis';
...
const listIcons = [HomeIcon, GroupIcon, BusinessIcon, WorkIcon];
    ...
    <Router>
      <Box sx={{ display: 'flex', minHeight: '100vh', backgroundColor: '#EEF3F6', width: '100%', overflow: 'auto' }}>
        ...
        <Drawer variant="permanent" open={open}>
          ...
          <Divider />
          <List>
            {['Acceuil', 'Partenaires', 'Operation'].map((text, index) => (
              <ListItem disablePadding sx={{ minHeight: 48 }} key={text}>
